...
import { _ as __nuxt_component_0 } from './Diashow-30a26dea.mjs';
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-d7bd2241"]]);
const { saveAs } = pkg;
const _sfc_main$2 = {
  props: {
    downloads: {
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))} data-v-3bf963e3><div class="text-center pb-2" data-v-3bf963e3><h3 data-v-3bf963e3>Aktuelle Downloads</h3></div><!--[-->`);
  ssrRenderList($props.downloads, (download, index2) => {
    _push(`<div class="downloads" data-v-3bf963e3><div class="download-grid" data-v-3bf963e3><p${ssrRenderAttr("href", download.pdf.url)} data-v-3bf963e3>${ssrInterpolate(download.title)}</p><svg xmlns="http://www.w3.org/2000/svg" stroke-width="1.5" stroke="lightgrey" class="downloadButton" fill="currentColor" viewBox="-1 -1 19 19" data-v-3bf963e3><path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z" data-v-3bf963e3></path><path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z" data-v-3bf963e3></path></svg></div></div>`);
  });
  _push(`<!--]--></div>`);
}
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-3bf963e3"]]);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-2b75efed><head data-v-2b75efed><title data-v-2b75efed>KPJH</title></head><svg class="svg" data-v-2b75efed><clipPath id="wave" clipPathUnits="objectBoundingBox" data-v-2b75efed><path id="path272" d="M 1,0 H 0 V 1 0.999 0.953 C 0.07338835,0.962484 0.16696688,0.9876246 0.24601002,0.9905464 0.41720789,0.9968744 0.56553662,0.96840898 0.70699957,0.9527569 0.86558789,0.93520999 0.9115516,0.94172711 1,0.953 V 0" data-v-2b75efed></path></clipPath></svg><header data-v-2b75efed><!--[-->`);
  ...
  _push(`<!--]--></header><section data-v-2b75efed><h4 class="text-center" data-v-2b75efed>Aktuelles</h4><div class="timeline" data-v-2b75efed><!--[-->`);
  ssrRenderList($setup.events, (event, index2) => {
    _push(`<div class="event" data-v-2b75efed>`);
    if (event) {
  ...
  _push(`<svg class="wave" viewBox="0 0 1440 139" fill="var(--secondaryBg)" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" data-v-2b75efed><path d="M381.765 99.5C236.064 99.5 70.549 125.567 0 138.6V0H1440V114.522C1373.95 109.515 1255.77 138.6 1021.21 138.6C728.005 138.6 563.892 99.5 381.765 99.5Z" data-v-2b75efed></path></svg></section>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-2b75efed"]]);

export { index as default };
//# sourceMappingURL=index-4c47ae49.mjs.map
