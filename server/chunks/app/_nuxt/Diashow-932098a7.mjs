...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "pictures" }, _attrs))} data-v-52f760a9>`);
  if ($props.images.length > 1) {
    _push(`<div class="prevButton" data-v-52f760a9><svg viewBox="0 0 28 18" fill="white" xmlns="http://www.w3.org/2000/svg" data-v-52f760a9><path d="M15.9639 16.2952C14.8821 17.4034 13.1179 17.4034 12.0361 16.2952L0.801466 4.78587C-0.267156 3.69112 -0.267156 1.92596 0.801466 0.831215C1.88326 -0.277029 3.64744 -0.277029 4.72924 0.831215L14 10.5L23.2708 0.831214C24.3526 -0.27703 26.1167 -0.27703 27.1985 0.831214C28.2672 1.92596 28.2672 3.69112 27.1985 4.78587L15.9639 16.2952Z" data-v-52f760a9></path></svg></div>`);
  } else {
    _push(`<!---->`);
  }
        ...
        ssrRenderList($props.images, (image, index) => {
          _push2(ssrRenderComponent(_component_Slide, { key: index }, {
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<img${ssrRenderAttr("srcset", `${image}&w=480 480w, ${image}&w=800 800w, ${image}&w=1200 1200w`)}${ssrRenderAttr("sizes", `(max-width: 600px) 480px, (max-width: 1000px) 800px, (max-width: 1800px) 1200px, 2000px`)}${ssrRenderAttr("src", image)} class="slideImg" style="${ssrRenderStyle({ width: $props.width, height: $props.height })}" data-v-52f760a9${_scopeId2}>`);
              } else {
                return [
                  createVNode("img", {
  ...
  _push(`<div class="nextButton" data-v-52f760a9>`);
  if ($props.images.length > 1) {
    _push(`<svg viewBox="0 0 28 18" fill="white" xmlns="http://www.w3.org/2000/svg" data-v-52f760a9><path d="M15.9639 16.2952C14.8821 17.4034 13.1179 17.4034 12.0361 16.2952L0.801466 4.78587C-0.267156 3.69112 -0.267156 1.92596 0.801466 0.831215C1.88326 -0.277029 3.64744 -0.277029 4.72924 0.831215L14 10.5L23.2708 0.831214C24.3526 -0.27703 26.1167 -0.27703 27.1985 0.831214C28.2672 1.92596 28.2672 3.69112 27.1985 4.78587L15.9639 16.2952Z" data-v-52f760a9></path></svg>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div></div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-52f760a9"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=Diashow-932098a7.mjs.map
