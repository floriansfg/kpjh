...
import { _ as _export_sfc, g as __nuxt_component_2 } from '../server.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "pictures" }, _attrs))} data-v-08fe131e>`);
  if ($props.images.length > 1) {
    _push(`<div class="prevButton" data-v-08fe131e><svg viewBox="0 0 28 18" fill="white" xmlns="http://www.w3.org/2000/svg" data-v-08fe131e><path d="M15.9639 16.2952C14.8821 17.4034 13.1179 17.4034 12.0361 16.2952L0.801466 4.78587C-0.267156 3.69112 -0.267156 1.92596 0.801466 0.831215C1.88326 -0.277029 3.64744 -0.277029 4.72924 0.831215L14 10.5L23.2708 0.831214C24.3526 -0.27703 26.1167 -0.27703 27.1985 0.831214C28.2672 1.92596 28.2672 3.69112 27.1985 4.78587L15.9639 16.2952Z" data-v-08fe131e></path></svg></div>`);
  } else {
    _push(`<!---->`);
  }
  ...
  _push(`<div class="nextButton" data-v-08fe131e>`);
  if ($props.images.length > 1) {
    _push(`<svg viewBox="0 0 28 18" fill="white" xmlns="http://www.w3.org/2000/svg" data-v-08fe131e><path d="M15.9639 16.2952C14.8821 17.4034 13.1179 17.4034 12.0361 16.2952L0.801466 4.78587C-0.267156 3.69112 -0.267156 1.92596 0.801466 0.831215C1.88326 -0.277029 3.64744 -0.277029 4.72924 0.831215L14 10.5L23.2708 0.831214C24.3526 -0.27703 26.1167 -0.27703 27.1985 0.831214C28.2672 1.92596 28.2672 3.69112 27.1985 4.78587L15.9639 16.2952Z" data-v-08fe131e></path></svg>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div></div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-08fe131e"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=Diashow-6346f502.mjs.map
