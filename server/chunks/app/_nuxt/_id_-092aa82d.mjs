import { _ as __nuxt_component_0 } from './DefaultView-fbd45d0d.mjs';
...
import { _ as __nuxt_component_0$1 } from './Diashow-932098a7.mjs';
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><div class="accordion accordion-flush" data-v-4a468d73><!--[-->`);
  ssrRenderList($data.folders, (folder, index) => {
    _push(`<div class="accordion-item" data-v-4a468d73><h2 class="accordion-header" data-v-4a468d73><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"${ssrRenderAttr("data-bs-target", "#" + folder.id)} aria-expanded="false" data-v-4a468d73>${ssrInterpolate(folder.name)}</button></h2><div${ssrRenderAttr("id", folder.id)} class="accordion-collapse collapse" data-v-4a468d73>`);
    if (folder.id) {
      _push(`<div class="accordion-body" data-v-4a468d73>`);
  ...
  _push(`<!--]--></div>`);
  if ($data.images) {
    _push(`<div class="photoGrid" data-v-4a468d73><!--[-->`);
    ssrRenderList($data.images, (image, index) => {
      _push(`<img${ssrRenderAttr("src", image.thumbnailLink)} referrerpolicy="no-referrer" data-v-4a468d73>`);
    });
    _push(`<!--]--></div>`);
  } else {
    _push(`<!---->`);
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        if (!$data.images[$data.clickedImage].loaded) {
          _push2(`<div class="loader" data-v-4a468d73${_scopeId}></div>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`<svg xmlns="http://www.w3.org/2000/svg" stroke-width="1.5" stroke="white" class="downloadButton" fill="currentColor" viewBox="-1 -1 19 19" data-v-4a468d73${_scopeId}><path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z" data-v-4a468d73${_scopeId}></path><path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z" data-v-4a468d73${_scopeId}></path></svg>`);
      } else {
        return [
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-4a468d73"]]);
const useLogin = () => {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_DefaultView, mergeProps({ titel: "Fotos" }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<head data-v-fe990caf${_scopeId}><title data-v-fe990caf${_scopeId}>KPJH - Fotos</title></head><div class="wrapper" data-v-fe990caf${_scopeId}><h3 class="title" data-v-fe990caf${_scopeId}>${ssrInterpolate($setup.album.eventType)} ${ssrInterpolate($setup.album.title)}</h3>`);
        _push2(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<svg viewBox="0 0 24 39" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-fe990caf${_scopeId2}><path d="M1.16478 22.2354C-0.388259 20.7286 -0.388259 18.2714 1.16478 16.7646L17.2934 1.11633C18.8275 -0.37211 21.3011 -0.37211 22.8352 1.11633C24.3883 2.62312 24.3883 5.08036 22.8352 6.58715L9.28584 19.5L22.8352 32.4128C24.3883 33.9196 24.3883 36.3769 22.8352 37.8837C21.3011 39.3721 18.8275 39.3721 17.2934 37.8837L1.16478 22.2354Z" fill="#3D5C6D" fill-opacity="0.4" data-v-fe990caf${_scopeId2}></path></svg>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  viewBox: "0 0 24 39",
        ...
        _push2(`<h3 data-v-fe990caf${_scopeId}>${ssrInterpolate($setup.album.eventDate)}</h3><div class="map" data-v-fe990caf${_scopeId}>`);
        ...
        if (("useState" in _ctx ? _ctx.useState : unref(useState))("loggedIn").value) {
          _push2(`<div class="photos" data-v-fe990caf${_scopeId}>`);
          ...
          _push2(`<div class="contentLocked" data-v-fe990caf${_scopeId}><svg viewBox="0 0 34 41" xmlns="http://www.w3.org/2000/svg" fill="#304C5C" data-v-fe990caf${_scopeId}><path d="M32.0002 18.4503H30.0003V13.3252C30.0003 5.94521 24.2003 0 17 0C9.79975 0 3.99969 5.94503 3.99969 13.3252V18.4503H1.99984C0.899796 18.4503 0 19.3726 0 20.5001V38.9502C0 40.0777 0.89985 41 1.99984 41H32.0002C33.1002 41 34 40.0777 34 38.9502V20.5001C34 19.3726 33.1002 18.4503 32.0002 18.4503ZM7.99991 13.3252C7.99991 8.20022 11.9996 4.10057 16.9996 4.10057C21.9997 4.10057 25.9994 8.20022 25.9994 13.3252V18.4503H7.99919L7.99991 13.3252Z" data-v-fe990caf${_scopeId}></path></svg><p data-v-fe990caf${_scopeId}>Bitte melde dich an um<br data-v-fe990caf${_scopeId}>alle Bilder sehen zu k\xF6nnen:</p><button class="btn btn-primary" data-v-fe990caf${_scopeId}> Anmelden </button></div>`);
        }
        _push2(`</div>`);
      } else {
        return [
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-fe990caf"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-092aa82d.mjs.map
